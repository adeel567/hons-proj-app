    ...
    >
      ...
      <Card.Content style={{ marginBottom: 10, marginTop: -5 }}>
            ...
            <List.Item
              ...
              right={(props) => (
                <Text style={{ marginTop: 8 }}>
                  {"£" + Number(item.pence / 100).toFixed(2)}
                </Text>
              )}
            />
          );
        ...
        <List.Item
          ...
          right={(props) => (
            <Text style={{ marginTop: 8 }}>
              {"£" + Number(orderInfo.subtotal_pence / 100).toFixed(2)}
            </Text>
          )}
        />
        <List.Item
          ...
          right={(props) => (
            <Text style={{ marginTop: 8 }}>
              {"£" + Number(orderInfo.delivery_pence / 100).toFixed(2)}
            </Text>
          )}
        />
        <List.Item
          ...
          right={(props) => (
            <Text style={{ marginTop: 8 }}>
              {"£" + Number(orderInfo.total_pence / 100).toFixed(2)}
            </Text>
          )}
        />
      </Card.Content>
