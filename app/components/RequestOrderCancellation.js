...
export const RequestOrderCancellation = (props) => {
  ...
  const { triggerOrderRefresh, setTriggerOrderRefresh } =
  ...
  const cancelCall = () => {
    Alert.alert(
      ...
      [{ text: "Confirm", onPress: cancelCall2 }, { text: "Cancel" }]
    );
  };
  ...
  const cancelCall2 = () => {
    ...
    axiosInstance
      ...
      .catch((error) => {
        ...
        Alert.alert("Order Cancellation", err_text, [{ text: "OK" }]);
      });
  };
