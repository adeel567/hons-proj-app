...
it("Clicking on an order should take you to the screen for that order", async () => {
    ...
    await waitFor(() => {
        ...
        expect(navigation.navigate).toHaveBeenCalledWith("OrderDetailsScreen", {order_id:21})
    })
})
...
it("Pressing sort should do sort (id ascending)", async () => {
    ...
    await waitFor(() => {
        ...
        expect(screen.getAllByTestId("orderDeliveryDate")[0]).toHaveTextContent("Delivery date: 2023-01-02");
    })
})
...
it("Pressing sort should do sort (id descending)", async () => {
    ...
    await waitFor(() => {
        ...
        expect(screen.getAllByTestId("orderDeliveryDate")[0]).toHaveTextContent("Delivery date: 2022-12-25");
    })
})
