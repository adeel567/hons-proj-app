...
export const ResetPasswordScreen = () => {
  ...
  const confirm_reset_local = () => {
    ...
    if (
      ...
      Alert.alert(
        ...
        "Code and/or password fields cannot be left empty",
        [{ text: "OK" }]
      );
      return;
    }
  ...
  const reset_password = (email) => {
    ...
    axiosInstance
      ...
      .then(() => {
        Alert.alert(
          "Reset Password",
          "If this email is associated with an active account, a code has been sent which can be used below.",
          [{ text: "OK" }]
        );
      })
      .catch((error) => {
        console.log(error);
        Alert.alert('"Reset Password Error"', err_text, [{ text: "OK" }]);
      })
      .finally(() => {
        setIsLoading(false);
      });
  ...
  const confirm_reset = (token, password) => {
    ...
    axiosInstance
      .post("/auth/reset-password/confirm/", params)
      .then(() => {
      ...
      <ScrollView>
        <View style={style.content}>
          <Title style={style.title}>
            Pop your email in below to reset your password!
          </Title>
        ...
        <View style={style.content}>
          <Title style={style.title}>
            Enter the code received in your email to set a new password.
          </Title>
