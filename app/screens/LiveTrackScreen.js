    ...
    return (
        <View style={styles.map}>
            ...
            />
                ...
                {orderInfo.pickups.map((pickup, index) => (//display each restaurant as a custom marker
                    (<Marker
                        title="Pickup"
                        key={index}
                        icon={shop}
            ...
            <SafeAreaView style={styles.footer}>
                <LiveTrackFooter trackable={trackable} trackingInfo={trackingInfo} onRefresh={onRefresh} isRefreshing={isRefreshing} />
            </SafeAreaView>
        </View>
    )
}
